...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-1 pt-28 px-4 flex items-center justify-center">
        <motion.div
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 border border-border rounded-full font-display text-sm flex items-center justify-center gap-3 hover:bg-secondary transition-all"
          >
